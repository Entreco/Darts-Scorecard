...
//            23 -> Not possible
    ...
    private fun guessThree(scored: Int): Turn {
        return when (scored) {
            ...
            100 -> Turn(Dart.ZERO, Dart.TRIPLE_20, Dart.DOUBLE_20) // "T20 D20")
            99 -> Turn(Dart.TRIPLE_19, Dart.SINGLE_10, Dart.DOUBLE_16) //"T19 10 D16"
            98 -> Turn(Dart.ZERO, Dart.TRIPLE_20, Dart.DOUBLE_19) //"T20 D19"
            97 -> Turn(Dart.ZERO, Dart.TRIPLE_19, Dart.DOUBLE_20) //"T19 D20"
            96 -> Turn(Dart.ZERO, Dart.TRIPLE_20, Dart.DOUBLE_18) //"T20 D18"
            95 -> Turn(Dart.ZERO, Dart.TRIPLE_19, Dart.DOUBLE_19) //"T19 D19"
            94 -> Turn(Dart.ZERO, Dart.TRIPLE_18, Dart.DOUBLE_20) //"T18 D20"
            93 -> Turn(Dart.ZERO, Dart.TRIPLE_19, Dart.DOUBLE_18) //"T19 D18"
            92 -> Turn(Dart.ZERO, Dart.TRIPLE_20, Dart.DOUBLE_16) //"T20 D16"
            91 -> Turn(Dart.ZERO, Dart.TRIPLE_17, Dart.DOUBLE_20) //"T17 D20"
            90 -> Turn(Dart.ZERO, Dart.TRIPLE_20, Dart.DOUBLE_15) //"T20 D15"
            89 -> Turn(Dart.ZERO, Dart.TRIPLE_19, Dart.DOUBLE_16) //"T19 D16"
            88 -> Turn(Dart.ZERO, Dart.TRIPLE_16, Dart.DOUBLE_20) //"T16 D20"
            87 -> Turn(Dart.ZERO, Dart.TRIPLE_17, Dart.DOUBLE_18) //"T17 D18"
            86 -> Turn(Dart.ZERO, Dart.TRIPLE_18, Dart.DOUBLE_16) //"T18 D16"
            85 -> Turn(Dart.ZERO, Dart.TRIPLE_15, Dart.DOUBLE_20) //"T15 D20"
            84 -> Turn(Dart.ZERO, Dart.TRIPLE_20, Dart.DOUBLE_12) //"T20 D12"
            83 -> Turn(Dart.ZERO, Dart.TRIPLE_17, Dart.DOUBLE_16) //"T17 D16"
            82 -> Turn(Dart.ZERO, Dart.TRIPLE_14, Dart.DOUBLE_20) //"T14 D20"
            81 -> Turn(Dart.ZERO, Dart.TRIPLE_19, Dart.DOUBLE_12) //"T19 D12"
            80 -> Turn(Dart.ZERO, Dart.TRIPLE_20, Dart.DOUBLE_10) //"T20 D10"
            79 -> Turn(Dart.ZERO, Dart.TRIPLE_13, Dart.DOUBLE_20) //"T13 D20"
            78 -> Turn(Dart.ZERO, Dart.TRIPLE_18, Dart.DOUBLE_12) //"T18 D12"
            77 -> Turn(Dart.ZERO, Dart.TRIPLE_19, Dart.DOUBLE_10) //"T19 D10"
            76 -> Turn(Dart.ZERO, Dart.TRIPLE_20, Dart.DOUBLE_8) //"T20 D8"
            75 -> Turn(Dart.ZERO, Dart.TRIPLE_17, Dart.DOUBLE_12) //"T17 D12"
            74 -> Turn(Dart.ZERO, Dart.TRIPLE_18, Dart.DOUBLE_10) //"T18 D10"
            73 -> Turn(Dart.ZERO, Dart.TRIPLE_19, Dart.DOUBLE_8) //"T19 D8"
            72 -> Turn(Dart.ZERO, Dart.TRIPLE_12, Dart.DOUBLE_18) //"T12 D18"
            71 -> Turn(Dart.ZERO, Dart.TRIPLE_17, Dart.DOUBLE_10) //"T17 D10"
            70 -> Turn(Dart.ZERO, Dart.TRIPLE_10, Dart.DOUBLE_20) //"T10 D20"
            69 -> Turn(Dart.ZERO, Dart.TRIPLE_13, Dart.DOUBLE_15) //"T13 D15"
            68 -> Turn(Dart.ZERO, Dart.TRIPLE_20, Dart.DOUBLE_4) //"T20 D4"
            67 -> Turn(Dart.ZERO, Dart.TRIPLE_17, Dart.DOUBLE_8) //"T17 D8"
            66 -> Turn(Dart.ZERO, Dart.TRIPLE_10, Dart.DOUBLE_18) //"T10 D18"
            65 -> Turn(Dart.ZERO, Dart.SINGLE_BULL, Dart.DOUBLE_20) //"S.BULL D20"
            64 -> Turn(Dart.ZERO, Dart.TRIPLE_16, Dart.DOUBLE_8) //"T16 D8"
            63 -> Turn(Dart.ZERO, Dart.TRIPLE_13, Dart.DOUBLE_12) //"T13 D12"
            62 -> Turn(Dart.ZERO, Dart.TRIPLE_10, Dart.DOUBLE_16) //"T10 D16"
            61 -> Turn(Dart.ZERO, Dart.SINGLE_BULL, Dart.DOUBLE_18) //"25 D18"
            60 -> Turn(Dart.ZERO, Dart.SINGLE_20, Dart.DOUBLE_20) //"20 D20"
            59 -> Turn(Dart.ZERO, Dart.SINGLE_19, Dart.DOUBLE_20) //"19 D20"
            58 -> Turn(Dart.ZERO, Dart.SINGLE_18, Dart.DOUBLE_20) //"18 D20"
            57 -> Turn(Dart.ZERO, Dart.SINGLE_17, Dart.DOUBLE_20) //"17 D20"
            56 -> Turn(Dart.ZERO, Dart.TRIPLE_16, Dart.DOUBLE_4) //"T16 D4"
            55 -> Turn(Dart.ZERO, Dart.SINGLE_15, Dart.DOUBLE_20) //"15 D20"
            54 -> Turn(Dart.ZERO, Dart.SINGLE_14, Dart.DOUBLE_20) //"14 D20"
            53 -> Turn(Dart.ZERO, Dart.SINGLE_13, Dart.DOUBLE_20) //"13 D20"
            52 -> Turn(Dart.ZERO, Dart.TRIPLE_12, Dart.DOUBLE_8) //"T12 D8"
            51 -> Turn(Dart.ZERO, Dart.SINGLE_11, Dart.DOUBLE_20) //"11 D20"
            50 -> Turn(Dart.ZERO, Dart.ZERO, Dart.BULL) //"BULL" // Special case
            49 -> Turn(Dart.ZERO, Dart.SINGLE_9, Dart.DOUBLE_20) //"9 D20"
            48 -> Turn(Dart.ZERO, Dart.SINGLE_16, Dart.DOUBLE_16) //"16 D16"
            47 -> Turn(Dart.ZERO, Dart.SINGLE_15, Dart.DOUBLE_16) //"15 D16"
            46 -> Turn(Dart.ZERO, Dart.SINGLE_6, Dart.DOUBLE_20) //"6 D20"
            45 -> Turn(Dart.ZERO, Dart.SINGLE_13, Dart.DOUBLE_16) //"13 D16"
            44 -> Turn(Dart.ZERO, Dart.SINGLE_12, Dart.DOUBLE_16) //"12 D16"
            43 -> Turn(Dart.ZERO, Dart.SINGLE_11, Dart.DOUBLE_16) //"11 D16"
            42 -> Turn(Dart.ZERO, Dart.SINGLE_10, Dart.DOUBLE_16) //"10 D16"
            41 -> Turn(Dart.ZERO, Dart.SINGLE_9, Dart.DOUBLE_16) //"9 D16"
            40 -> Turn(Dart.ZERO, Dart.ZERO, Dart.DOUBLE_20) //"D20"
            39 -> Turn(Dart.ZERO, Dart.SINGLE_7, Dart.DOUBLE_16) //"7 D16"
            38 -> Turn(Dart.ZERO, Dart.ZERO, Dart.DOUBLE_19) //"D19"
            37 -> Turn(Dart.ZERO, Dart.SINGLE_5, Dart.DOUBLE_16) //"5 D16"
            36 -> Turn(Dart.ZERO, Dart.ZERO, Dart.DOUBLE_18) //"D18"
            35 -> Turn(Dart.ZERO, Dart.SINGLE_3, Dart.DOUBLE_16) //"3 D16"
            34 -> Turn(Dart.ZERO, Dart.ZERO, Dart.DOUBLE_17) //"D17"
            33 -> Turn(Dart.ZERO, Dart.SINGLE_1, Dart.DOUBLE_16) //"1 D16"
            32 -> Turn(Dart.ZERO, Dart.ZERO, Dart.DOUBLE_16) //"D16"
            31 -> Turn(Dart.ZERO, Dart.SINGLE_15, Dart.DOUBLE_8) //"15 D8"
            30 -> Turn(Dart.ZERO, Dart.ZERO, Dart.DOUBLE_15) //"D15"
            29 -> Turn(Dart.ZERO, Dart.SINGLE_13, Dart.DOUBLE_8) //"13 D8"
            28 -> Turn(Dart.ZERO, Dart.ZERO, Dart.DOUBLE_14) //"D14"
            27 -> Turn(Dart.ZERO, Dart.SINGLE_19, Dart.DOUBLE_4) //"19 D4"
            26 -> Turn(Dart.ZERO, Dart.ZERO, Dart.DOUBLE_13) //"D13"
            25 -> Turn(Dart.ZERO, Dart.SINGLE_17, Dart.DOUBLE_4) //"17 D4"
            24 -> Turn(Dart.ZERO, Dart.ZERO, Dart.DOUBLE_12) //"D12"
            23 -> Turn(Dart.ZERO, Dart.SINGLE_7, Dart.DOUBLE_8) //"7 D8"
            22 -> Turn(Dart.ZERO, Dart.ZERO, Dart.DOUBLE_11) //"D11"
            21 -> Turn(Dart.ZERO, Dart.SINGLE_5, Dart.DOUBLE_8) //"5 D8"
            20 -> Turn(Dart.ZERO, Dart.ZERO, Dart.DOUBLE_10) //"D10"
            19 -> Turn(Dart.ZERO, Dart.SINGLE_11, Dart.DOUBLE_4) //"11 D4"
            18 -> Turn(Dart.ZERO, Dart.ZERO, Dart.DOUBLE_9) //"D9"
            17 -> Turn(Dart.ZERO, Dart.SINGLE_9, Dart.DOUBLE_4) //"9 D4"
            16 -> Turn(Dart.ZERO, Dart.ZERO, Dart.DOUBLE_8) //"D8"
            15 -> Turn(Dart.ZERO, Dart.SINGLE_7, Dart.DOUBLE_4) //"7 D4"
            14 -> Turn(Dart.ZERO, Dart.ZERO, Dart.DOUBLE_7) //"D7"
            13 -> Turn(Dart.ZERO, Dart.SINGLE_5, Dart.DOUBLE_4) //"5 D4"
            12 -> Turn(Dart.ZERO, Dart.ZERO, Dart.DOUBLE_6) //"D6"
            11 -> Turn(Dart.ZERO, Dart.SINGLE_3, Dart.DOUBLE_4) //"3 D4"
            10 -> Turn(Dart.ZERO, Dart.ZERO, Dart.DOUBLE_5) //"D5"
            9 -> Turn(Dart.ZERO, Dart.SINGLE_1, Dart.DOUBLE_4)
            8 -> Turn(Dart.ZERO, Dart.ZERO, Dart.DOUBLE_4)
            7 -> Turn(Dart.ZERO, Dart.SINGLE_3, Dart.DOUBLE_2)
            6 -> Turn(Dart.ZERO, Dart.ZERO, Dart.DOUBLE_3)
            5 -> Turn(Dart.ZERO, Dart.SINGLE_1, Dart.DOUBLE_2)
            4 -> Turn(Dart.ZERO, Dart.ZERO, Dart.DOUBLE_2)
            3 -> Turn(Dart.ZERO, Dart.SINGLE_1, Dart.DOUBLE_1)
            2 -> Turn(Dart.ZERO, Dart.ZERO, Dart.DOUBLE_1)
            1 -> Turn(Dart.ZERO, Dart.ZERO, Dart.SINGLE_1)
