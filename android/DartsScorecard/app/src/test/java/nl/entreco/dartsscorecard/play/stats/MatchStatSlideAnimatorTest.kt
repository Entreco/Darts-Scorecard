...
class MatchStatSlideAnimatorTest {
    ...
    private fun givenSubject() {
        subject = MatchStatSlideAnimator.MatchStatSlideAnimatorHandler(mockView, mockView, mockView, mockView, mockView, mockView, mockView, mockView, mockView, mockView, mockView, mockView)
    }
